...
PACKAGE ?= helm-argo-rollouts
XRD_DIR := apis/argorollouts
...
EXAMPLES := \
    examples/argorollouts/minimal.yaml:: \
    examples/argorollouts/standard.yaml::
...
render\:%:
	@example="examples/argorollouts/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
